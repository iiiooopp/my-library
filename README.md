...
1. 获取官方最新[sql文件](https://github.com/openzipkin/zipkin/blob/master/zipkin-storage/mysql-v1/src/main/resources/mysql.sql) ，创建数据库
...
2. 修改Zipkin的启动参数
    ...
    `java -jar /home/zipkin-server-2.22.2-exec.jar --STORAGE_TYPE=MYSQL --MYSQL_DB=test --MYSQL_USER=root --MYSQL_PASS=123456 --MYSQL_HOST=localhost --MYSQL_TCP_PORT=3306`
